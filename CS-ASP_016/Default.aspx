...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Calendar ID="myCalendar" runat="server" BackColor="White" BorderColor="Black" DayNameFormat="Shortest" Font-Names="Times New Roman" Font-Size="10pt" ForeColor="Black" Height="220px" NextPrevFormat="FullMonth" OnSelectionChanged="myCalendar_SelectionChanged" SelectionMode="DayWeek" TitleFormat="Month" Width="400px">
